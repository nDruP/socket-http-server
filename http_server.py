...
def response_not_found():
    ...
    return b"\r\n".join([
        ...
        b"Content-Type: text/plain",
        b"",
        b"<html><h1>404! Page Not Found</h1></html>"
    ])
    ...
    try:
        while True:
            ...
            try:
                ...
                try:
                    req_path = parse_request(request)
                    content, mimetype = response_path(req_path)
